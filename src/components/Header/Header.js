            ...
            <div className={clsx(styles.DivHeaderWrapperMain)}>
                ...
                <div>
                    <form className={clsx(styles.FormElement)} action="/search">
                        <input type="search" placeholder="Search accounts and videos" name="q" autoComplete="off" data-e2e="search-user-input" className={clsx(styles.InputElement)} />
                        <span className={clsx(styles.SpanSpliter)}></span>
                        <button type="submit" style={{ border: 0 }} data-e2e="search-button" className="tiktok-3n0ac4-ButtonSearch ev30f216">
